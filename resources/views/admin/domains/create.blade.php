...
Example.net"></textarea>
                        ...
                        <div class="col-span-2 space-y-1">
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center">
                                    <input type="radio" name="allow_offer" value="1" x-model="allowOffer" class="border border-gray-200 h-4 w-4 text-indigo-500 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" checked="checked" />
    ...
    <div class="flex flex-col rounded shadow-sm bg-white overflow-hidden hidden">
        <div class="py-4 px-5 lg:px-6 w-full bg-gray-50">
            <h3>域名添加</h3>
        </div>
        <div class="p-5 lg:p-6 flex-grow w-full">
            <form x-data="formContainer" action="{{ route('admin.domains.store') }}" method="post" class="space-y-6">
                <div hidden>
                    @csrf
                </div>
                <div class="space-y-1 md:space-y-0 md:flex">
                    ...
                    <input type="text" id="domain" name="domain" value="{{ old('domain') }}" class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full md:w-3/5 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入域名">
                </div>
                <div class="space-y-1 md:space-y-0 md:flex">
                    <label for="logo" class="font-semibold py-2 md:w-1/5 flex-none md:mr-6 text-right">LOGO</label>
                    <input type="text" id="logo" name="logo" value="{{ old('logo') }}" class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full md:w-3/5 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入LOGO">
                </div>
                <div class="space-y-1 md:space-y-0 md:flex">
                ...
                <div class="space-y-1 md:space-y-0 md:flex">
                    ...
                    <input type="text" id="seo_title" name="seo_title" value="{{ old('seo_title') }}" class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full md:w-3/5 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入网站标题">
                </div>
                <div class="space-y-1 md:space-y-0 md:flex md:items-center">
                    ...
                    <input type="text" id="seo_keywords" name="seo_keywords" value="{{ old('seo_keywords') }}" class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full md:w-3/5 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入网站关键词">
                </div>
                <div class="space-y-1 md:space-y-0 md:flex md:items-start">
                    ...
                    <textarea id="seo_description" name="seo_description" class="w-full md:w-3/5 block border border-gray-200 rounded px-3 py-2 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" rows="4" placeholder="请输入网站描述">{{ old('seo_description') }}</textarea>
                </div>
