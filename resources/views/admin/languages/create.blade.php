            ...
            <div class="p-5 lg:p-6 flex-grow w-full">
                ...
                <div class="space-y-6 md:w-2/3">
                    <div class="space-y-1">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入名称">
                    </div>
                    <div class="space-y-1">
                    ...
                    <div class="space-y-1">
                        <label for="default" class="text-gray-900 font-semibold"><span class="text-red-600 px-1">*</span>是否默认</label>
