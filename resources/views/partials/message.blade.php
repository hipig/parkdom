    ...
    <div x-data="{open: true}" x-show="open" class="p-4 md:p-5 rounded text-red-700 bg-red-100 relative">
        ...
        <div class="absolute top-0 right-0 mt-4 mr-4 md:mt-5 md:mr-5">
            <button type="button" x-on:click="open = false"
                    class="inline-flex justify-center items-center space-x-2 rounded border font-semibold focus:outline-none px-1 py-1 leading-5 text-sm border-transparent focus:ring focus:ring-opacity-50 text-red-600 hover:text-red-400 focus:ring-red-500 active:text-red-600">
