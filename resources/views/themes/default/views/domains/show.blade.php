...
@section('content')
    <main class="min-h-screen flex bg-gray-50 text-gray-700">
            ...
            <div class="flex-1 min-h-0 flex items-center py-5 px-4 lg:px-12">
                <div class="space-y-20">
                    <div class="flex flex-col items-center space-y-8">
                        ...
                        @endif
                        <p class="text-2xl text-gray-500 text-center">12 Years old premium domain name available for instantly purchase. Invest in a premium domain name to launch your brand.</p>
                    </div>
        ...
        <div class="w-5/12 flex flex-col justify-between bg-gray-100">
            <div class="flex-1 min-h-0 flex items-center justify-center py-4 px-6 lg:px-20">
                    ...
                    <div class="text-center space-y-6">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-4">
                                <div class="space-y-1">
                                    <div class="relative">
                                        <input type="text" class="w-full block placeholder-gray-400 border border-gray-200 rounded pl-12 pr-10 py-3 leading-6 text-lg focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="Your Name">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        <div class="relative">
                                            <input type="text" class="w-full block placeholder-gray-400 border border-gray-200 rounded pl-12 pr-10 py-3 leading-6 text-lg focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="email@example.com">
                                            <div class="absolute left-0 inset-y-0 w-12 my-px ml-px flex items-center justify-center text-gray-500">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <div class="space-y-1">
                                        <div class="relative">
                                            <input type="text" class="w-full block placeholder-gray-400 border border-gray-200 rounded pl-12 pr-5 py-3 leading-6 text-lg focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="123 000 0000">
                                            <div class="absolute left-0 inset-y-0 w-12 my-px ml-px flex items-center justify-center text-gray-500">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                                </svg>
                                ...
                                <div class="space-y-1">
                                    <div class="relative">
                                        <input type="text" class="w-full block placeholder-gray-400 border border-gray-200 rounded pl-12 pr-24 py-3 leading-6 text-lg focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="Enter Your Phone">
                                        ...
                                        <div class="absolute inset-y-0 right-0 w-16 my-px mr-px flex items-center justify-center pointer-events-none rounded-r font-semibold text-gray-500 bg-gray-100 border-l border-gray-200">
                                            <span>USD</span>
                                        </div>
                                ...
                                <div class="space-y-1">
                                    <textarea class="w-full block border border-gray-200 rounded px-3 py-2 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" rows="4" placeholder="Your message or offer details."></textarea>
                                </div>
                            </div>
                            <div class="space-y-6">
